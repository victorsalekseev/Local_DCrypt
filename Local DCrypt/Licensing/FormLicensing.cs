...
{
    partial class FormLicensing : Form
    {
        public FormLicensing()
        {
            InitializeComponent();
        ...
        public FormLicensing(bool isAbout)
        {
            InitializeComponent();
        ...
        private void Init()
        {
            this.labelProductName.Text = AssemblyProduct + " - " + String.Format("Version {0}", AssemblyVersion) + ". " + AssemblyCopyright;
